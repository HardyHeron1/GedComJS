...
describe('FamilyRecord', function() {
    ...
    describe('ParseTree', function () {
        it('testParse', function () {
            ...
            expect(this.familyRecord.id).to.equal("F001");
        });
        ...
        it('testParseFull', function () {
            ...
            expect(this.familyRecord.toString()).to.equal("(Id->F001, Restriction->none, Events->(), Husband->I001, Wife->I002, Child->I003, Child->I004, Child->I005, CountOfChildren->14, LdsSealings->(), UserRefNbrs->(UserRefNbr->117 (comic)), AutoRecId->42, ChangeDate->(Date->2010-03-2 undefined, Notes->()), SubmitterLinks->(Submitter->S001), Citations->(\n(Version->5.5.1, SourceId->S33, Page->undefined, EventType->undefined, RoleInEvent->undefined, EntryDate->undefined, Texts->(), Quay->undefined, MediaLinks->(), Notes->())), MediaLinks->(\n(Version->5.5.1, Id->O14)), Notes->(\n(Version->5.5.1, Text->van Gogh Rocks!)))");
        });
    });
    describe('ToGedcom', function () {
        it('toGedcom', function () {
            this.familyRecord = new FamilyRecord();
            this.familyRecord.parseTree([['0 @F001@ FAM']], '5.5.1');
            expect(this.familyRecord.toGedcom(0, '5.5.1')).to.equal("0 @F001@ FAM");
        });
